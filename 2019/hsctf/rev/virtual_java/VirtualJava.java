        ...
        while (this.running) {
            ...
            switch (opc) {
                case 0x0: //add
                    x = pop();
                    y = pop();
					System.out.println(String.format("%d : add 0x%x,0x%x",this.ip,x,y));
                    push(x + y);
                    break;
                case 0x1: { //sub
                    y = pop();
                    x = pop();
					System.out.println(String.format("%d : sub 0x%x,0x%x",this.ip,x,y));
                    push(x - y);
                    break;
                }
                case 0x2: //mul
                    y = pop();
                    x = pop();
					System.out.println(String.format("%d : mul 0x%x,0x%x",this.ip,x,y));
                    push(y * x);
                    break;
                case 0x3:  //div
                    y = pop();
                    x = pop();
					System.out.println(String.format("%d : div 0x%x,0x%x",this.ip,x,y));
                    push(x / y);
                    break;
                case 0x4: //je
                    y = pop();
					System.out.println(String.format("%d : je 0x%x",this.ip,y,opn));
                    if (y == 0) this.ip = opn;
                    break;
                case 0x5: //jne
                    y = pop();
					System.out.println(String.format("%d : jne 0x%x",this.ip,y,opn));
                    if (y != 0) this.ip = opn;
                    break;
                case 0x6: //push
					System.out.println(String.format("%d : push 0x%x",this.ip,opn));
                    push(opn);
                    break;
                case 0x7: //and
                    x = pop();
                    y = pop();
					System.out.println(String.format("%d : and 0x%x,0x%x",this.ip,x,y));
                    push(x & y);
                    break;
                case 0x8: //or
                    x = pop();
                    y = pop();
					System.out.println(String.format("%d : or 0x%x,0x%x",this.ip,x,y));
                    push(x | y);
                    break;
                case 0x9: //xor
                    x = pop();
                    y = pop();
					System.out.println(String.format("%d : xor 0x%x,0x%x",this.ip,x,y));
                    push(x ^ y);
                    break;
                case 0xa: //dup
                    int a = pop();
					System.out.println(String.format("%d : dup 0x%x",this.ip,a));
                    push(a);
                    push(a);
                    break;
                case 0xb: //push_reg
					System.out.println(String.format("%d : push regs[0x%x] #0x%x",this.ip,opn,regs[opn]));
                    push(this.regs[opn]);
                    break;
                case 0xc: //exit
                    this.running = false;
